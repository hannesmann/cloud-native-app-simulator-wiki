...
* **processes**: The number of processes to spawn. Default: 1
* **threads**: The number of threads to spawn. Default: 1
...
* **execution_time**: Determines how much time the server will spend busy-waiting when responding to a request.
